...
\section{Ordered-Covering}
  ...
  The \textit{down-check} instead ensures that the entry that would result from performing a merge would not match a subset of the packets expected to match entries below the point where the entry resulting from the merge would be located.
