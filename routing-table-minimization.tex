...
We introduce Ordered-Covering (OC), a memory-efficient routing table minimizer which, subject to a heuristic which sorts the routing table and two rules which ensure the correctness of the final table, greedily merges entries with equivalent routes.
