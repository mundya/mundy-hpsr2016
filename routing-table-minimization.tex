...
\section{Ordered-Covering}
  ...
  \begin{itemize}
    \item OC performs well on given benchmarks
    \item Achieves X PERCENT of Espresso compression, sufficient for Y PERCENT of tables in the centroid benchmark
  \end{itemize}

  \subsection{Memory usage}

  \begin{itemize}
    \item Recording of OC memory usage?
    \item Note that alias table growth outstrips memory saved from minimizing the table
    \item Headline is that tables of useful sizes can be minimized within the memory and code-space available
  \end{itemize}
  ...
  \subsection{Effect of key-allocation}

  \begin{itemize}
    \item Makes very little difference
    \item Explain experiment, present largest table size for all schemes
  \end{itemize}
