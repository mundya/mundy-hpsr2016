...
Exploiting the massive parallelism of SpiNNaker to perform any minimisation of routing tables is desirable due to the large number of tables to minimise, \num{57600} in the largest configurations.
...
\end{figure*}
  ...
  While this is not true of the centroid benchmark, it is able to reduce \SI{48.6}{\percent} of the tables to fewer than 1024 entries.
