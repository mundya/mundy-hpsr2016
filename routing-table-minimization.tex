...
We introduce Ordered-Covering (OC), a memory-efficient routing table minimizer which greedily merges entries with equivalent routes subject to two rules which ensure the correctness of the resulting table.
