...
\begin{itemize}
  ...
  \item The C implementation of Ordered-Covering, used in our experiments, is also available online (\url{https://goo.gl/qM228T}) and may be compiled for either PC or SpiNNaker.
  \item Benchmarks and scripts are available online at: \\\url{https://goo.gl/uiMW4D}.
\end{itemize}
